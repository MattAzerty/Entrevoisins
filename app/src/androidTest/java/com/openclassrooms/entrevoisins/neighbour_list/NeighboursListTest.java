...
import com.openclassrooms.entrevoisins.ui.neighbour_list.UserInfoActivity;
...
public class NeighboursListTest {
    ...
    public ActivityTestRule<ListNeighbourActivity> mActivityRule =
            new ActivityTestRule(ListNeighbourActivity.class,true);
...
//Pressing the fav button
        onView(withId(R.id.user_info_activity_favorite)).perform(click());
//Go on favorites tab
        onView(withId(R.id.user_info_activity_back)).perform(click());
